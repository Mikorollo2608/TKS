...
public class ClientMongoRepository extends AbstractMongoRepository<ClientEntity> {
    ...
    private void init() {
        ...
        create(ClientMapper.toEntity(new Client(UUID.fromString("80e62401-6517-4392-856c-e22ef5f3d6a2"), "login", "normal")));
        create(ClientMapper.toEntity(new Client(UUID.fromString("b6f5bcb8-7f01-4470-8238-cc3320326157"), "login15", "athlete")));
        create(ClientMapper.toEntity(new Client(UUID.fromString("6dc63417-0a21-462c-a97a-e0bf6055a3ea"), "leeJo15", "coach")));
        create(ClientMapper.toEntity(new Client(UUID.fromString("3a722080-9668-42a2-9788-4695a4b9f5a7"), "scKrzy", "normal")));
        create(ClientMapper.toEntity(new Client(UUID.fromString("126778af-0e19-46d4-b329-0b6b92548f9a"), "scAdam", "normal")));
    }
